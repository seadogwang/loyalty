...
import com.loyalty.common.access.domain.ApiPermission;
import com.loyalty.common.access.domain.AuthzDecision;
import com.loyalty.common.access.domain.EffectiveGrant;
import com.loyalty.common.access.domain.ScopeType;
import com.loyalty.common.access.repository.ApiPermissionRegistry;
...
public class AuthorizationService {
    ...
    public AuthzDecision authorize(String method, String path, PrincipalContext principal, TenantContext tenant) {
        ...
        List<EffectiveGrant> grants = grantCache.load(principal.principalId());
    ...
    public boolean hasPermission(UUID principalId, String permissionCode, TenantContext tenant) {
        ...
        for (EffectiveGrant g : grantCache.load(principalId)) {
